        ...
        <div className="flex flex-col items-center sm:items-start">
          <div className="text-lg font-semibold text-gray-700 text-center sm:text-left">
            ...
            <div>
              ...
              <span className="italic text-pink-500">(self-proclaimed)</span>
            </div>
          </div>
          <p className="text-base text-gray-500 mt-2 text-center sm:text-left">
            &quot;I have read at least 2.5 self-help books and watched 100+
            motivational TikToks, so you know you can trust me.&quot;
          </p>
        </div>
      </div>
